# Generated by Django 4.2.5 on 2023-09-06 02:24
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='product',
            name='type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ims_app.producttype'),
        ),
        migrations.AddField(
            model_name='buyerinfo',
            name='company',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ims_app.companyinfo'),
        ),
        migrations.AddField(
            model_name='userinfo',
            name='company_info',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='ims_app.companyinfo'),
        ),
    ]
